...
namespace Watcher
{
    public class Config
    {
        ...
        public Config()
        {
            ...
            物品作弊警告方式_0口头私聊_1广播警告_2广播并网住_3广播并杀死_4广播并踢出 = 3;
            物品作弊是否算违规 = true;
            检测到违禁物时是否清空 = false;
            ...
            射弹最大伤害 = 5000;
            其他最大伤害 = 5000;
            伤害作弊警告方式_0口头私聊_1广播警告_2广播并网住_3广播并杀死_4广播并踢出 = 3;
            伤害作弊是否算违规 = true;


            启用浮标数目检测 = true;
            最大浮标数目 = 1;
            钓鱼作弊警告方式_0口头私聊_1广播警告_2广播并网住_3广播并杀死_4广播并踢出 = 3;
            钓鱼作弊是否算违规 = true;


            危险射弹广播警告 = true;
            生成危险射弹的频率_次每秒 = 1;
            生成危险射弹警告方式_0口头私聊_1广播警告_2广播并网住_3广播并杀死_4广播并踢出 = 1;
        ...
        public int 物品作弊警告方式_0口头私聊_1广播警告_2广播并网住_3广播并杀死_4广播并踢出;
        ...
        public int 射弹最大伤害;
        public int 其他最大伤害;
        public int 伤害作弊警告方式_0口头私聊_1广播警告_2广播并网住_3广播并杀死_4广播并踢出;
        public bool 伤害作弊是否算违规;


        public bool 启用浮标数目检测;
        public int 最大浮标数目;
        public int 钓鱼作弊警告方式_0口头私聊_1广播警告_2广播并网住_3广播并杀死_4广播并踢出;
        public bool 钓鱼作弊是否算违规;


        public bool 危险射弹广播警告;
        public int 生成危险射弹的频率_次每秒;
        public int 生成危险射弹警告方式_0口头私聊_1广播警告_2广播并网住_3广播并杀死_4广播并踢出;
